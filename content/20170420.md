...
<script src="./../data/madeleine/src/user/stats.js"></script>
<script src="./../data/madeleine/src/user/detector.js"></script>
<script src="./../data/madeleine/src/user/three.min.js"></script>
